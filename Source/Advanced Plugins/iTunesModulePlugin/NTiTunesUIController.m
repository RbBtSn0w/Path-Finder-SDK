...
@interface NTiTunesUIController ()
@property (nonatomic, retain) NSSplitView* splitView;
@property (nonatomic, retain) NTSplitViewDelegate* splitViewDelegate;
@property (nonatomic, assign) BOOL haveSetupSplitview;
@property (nonatomic, retain) NTiTunesUIModel* UIModel;
...
- (void)revealButtonAction:(id)sender;
{
	...
	if ([selection count])
	{
		NSArray* items = [[self host] makeFSItems:selection];
